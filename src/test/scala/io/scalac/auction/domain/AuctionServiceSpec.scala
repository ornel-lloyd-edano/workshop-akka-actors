...
class AuctionServiceSpec extends ScalaTestWithActorTestKit(s"""
  ...
  "AuctionService" should {
    ...
    "add a lot in some of the available auctions" in {
      val actor = testKit.spawn(AuctionActorManager("id-1"))
      val auctionService = new DefaultAuctionService(actor)
    ...
    "fail to bid if auction is not yet started" in {
      val actor = testKit.spawn(AuctionActorManager("id-1"))
      val auctionService = new DefaultAuctionService(actor)
      val result = for {
        _ <- auctionService.createAuction
    ...
    "start an auction and able to bid a lot" in {
      val actor = testKit.spawn(AuctionActorManager("id-1"))
      val auctionService = new DefaultAuctionService(actor)
      val result = for {
        _ <- auctionService.createAuction
    ...
    "fail to get a lot in non-existing auction" in {
      val actor = testKit.spawn(AuctionActorManager("id-1"))
      val auctionService = new DefaultAuctionService(actor)
      val result = for {
        _ <- auctionService.createAuction
    ...
    "fail to get non-existing lot in an existing auction" in {
      val actor = testKit.spawn(AuctionActorManager("id-1"))
      val auctionService = new DefaultAuctionService(actor)
      val result = for {
        _ <- auctionService.createAuction
    ...
    "end an auction and fail to add any more lot" in {
      val actor = testKit.spawn(AuctionActorManager("id-1"))
      val auctionService = new DefaultAuctionService(actor)
      val result = for {
        _ <- auctionService.createAuction
    ...
    "end an auction and fail to bid" in {
      val actor = testKit.spawn(AuctionActorManager("id-1"))
      val auctionService = new DefaultAuctionService(actor)
      val result = for {
        _ <- auctionService.createAuction
